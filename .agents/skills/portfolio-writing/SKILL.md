...
- **Short sentences. Concrete nouns. Varied rhythm.** Favor clarity, but do not stack sentences with the same subject-verb template. Break up runs like "Activation says... Retention says... Expansion says..." by combining related ideas, changing sentence length, or making the causal relationship explicit. Calibrate against three hand-written entries in this repo: `portfolio/content/work/geo-architecture-center.md`, `work/mapbox-boundaries-atlas.md`, and `work/mapbox-oss-datascience.md`. Read all three before drafting a long piece. Their shape is two short sentences, often one of them a quoted objection, then one longer layered sentence; sentence lengths there run from 4 to 52 words. If every sentence in a draft lands between 10 and 16 words, or the longest is under 25, the rhythm is wrong. For the failure mode, read the four-beat definition runs in `writing/loop-engineering-coding-agent.md` and do not write paragraphs shaped like those. Read every paragraph aloud: it should sound conversational, not like a glossary or generated checklist. Cut hype adjectives entirely: never "cutting-edge," "revolutionary," "innovative," "world-class," "passionate." The evidence carries the excitement.
